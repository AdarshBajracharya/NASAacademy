...
def edit():
    ...
    state_label= Label(editor,text = "First name")
    state_label.grid(row=4, column=0)

    zipcode_label= Label(editor,text = "Last name")
    ...
    edit_btn.grid(row = 6, column = 0, colummnspan =2, pady=10, padx = 10, ipadx = 125)
...
edit_button= Button(root,text="Update",command=edit)
edit_button.grid(row=11, column=0, columnspan=2, pady=10, padx=10, ipadx=120)
